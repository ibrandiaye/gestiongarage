    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('entree.create') }}" role="button" >ENREGISTRER entree</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div>
                    </div>
                ...
                <table id="example1" class="table table-bordered table-responsive-md table-striped text-center">
                    ...
                    @foreach ($entrees as $entree)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('entree.edit', $entree->id) }}" role="button" class="btn btn-primary"><i class="fas fa-edit"></i></a>
