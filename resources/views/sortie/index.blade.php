    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="btn-group float-right">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('sortie.create') }}" role="button" >ENREGISTRER sortie</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div>
                    </div>
                ...
                <table id="example1" class="table table-bordered table-responsive-md table-striped text-center">
                    ...
                    @foreach ($sorties as $sortie)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('.edit', $sortie->id) }}" role="button" class="btn btn-primary"><i class="fas fa-edit"></i></a>
